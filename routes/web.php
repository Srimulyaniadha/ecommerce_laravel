...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('/admin/distributors/edit/{id}', [DistributorController::class, 'edit'])->name('distributor.edit');
    Route::put('/admin/distributors/update/{id}', [DistributorController::class, 'update'])->name('distributor.update');
    Route::delete('/admin/distributors/delete/{id}', [DistributorController::class, 'delete'])->name('distributor.delete');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/flashsale/purchase/{flashSaleId}/{userId}', [UserController::class, 'purchase_flashSale'])->name('flashsale.purchase');
